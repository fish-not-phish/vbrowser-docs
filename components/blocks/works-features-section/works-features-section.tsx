...
const Features = ({ data }: { data: DataType[] }) => {
  ...
  return (
    <section id='works-features'>
      <SectionHeader title='How it works' description='Launch an isolated browser, investigate securely, and export evidence — all in three steps.' />
              ...
              {data.map(tab => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'focus-visible:ring-ring/50 relative flex cursor-pointer flex-col gap-6 px-8 py-14 text-left transition-colors duration-300 outline-none focus-visible:z-1 focus-visible:ring-3 sm:px-10 lg:px-12'
                    )}
                  >
