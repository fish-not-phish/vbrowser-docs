...
import { ChartPieIcon, Clock8Icon, FileChartPieIcon, LoaderIcon, ThumbsUpIcon, FolderIcon } from 'lucide-react'
  ...
  return (
    <div className='flex max-md:flex-col max-md:space-y-8 md:items-start'>
      <WorkflowItem
        ...
        description='Case opened for threat investigation.'
        time='0.0 sec'
      ...
      >
        <div className='bg-muted rounded-lg px-2.5 py-3'>
          <div className='flex items-center gap-2'>
            ...
            <span className='text-muted-foreground text-sm'>Case file</span>
          </div>
        </div>
      ...
      >
        ...
        <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
          ...
          <p className='text-muted-foreground text-sm'>Session recordings, traffic logs, and screenshots attached to the case.</p>
        </div>
      ...
      <div className='flex flex-col gap-8 md:gap-6'>
        <WorkflowItem
          ...
          description='Case summary posted to team channel for review.'
          time='24 min'
          delay={2.4}
        ...
        <WorkflowItem
          ...
          icon={<ThumbsUpIcon />}
          title='Case Assigned'
          description='Case routed to team member with full context.'
          time='4.1 sec'
          delay={3.6}
