...
import { ArrowDownUpIcon, FileInputIcon, MessageSquareTextIcon, ServerIcon, LockIcon, FolderCheckIcon } from 'lucide-react'
  ...
  return (
    <div className='flex max-md:flex-col max-md:space-y-8 md:items-start'>
      <WorkflowItem
        type='input'
        icon={<FileInputIcon />}
        title='Suspicious URL Submitted'
        description='Analyst submits a suspicious URL for safe investigation.'
        time='0.0 sec'
      ...
      >
        <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <span className='text-muted-foreground text-sm'>DNS resolution</span>
          </div>
          <div className='flex items-center gap-2'>
            <LockIcon className='size-4.5' />
            <span className='text-muted-foreground text-sm'>SSL certificate</span>
          </div>
        </div>
      ...
      >
        <div className='bg-muted rounded-lg px-2.5 py-3'>
          <p className='text-muted-foreground text-sm'>
            vBrowser provisions a fresh container on ECS Fargate and launches the browser in isolation.
          </p>
        </div>
      ...
      <WorkflowItem
        ...
        description='Traffic logs captured automatically; screenshots taken by the analyst.'
        time='0.0 sec'
        delay={2.4}
        className='md:mt-17'
      >
        <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
          ...
          <p className='text-muted-foreground text-sm'>
            Screenshots, traffic logs, and downloads are attached to the case, ready for analysis. Traffic is
            captured automatically; screenshots are taken by the analyst.
          </p>
          <div className='flex items-center gap-2'>
            <FolderCheckIcon className='size-4.5' />
            <span className='text-muted-foreground text-sm'>Evidence saved</span>
          </div>
        </div>
      </WorkflowItem>
    </div>
